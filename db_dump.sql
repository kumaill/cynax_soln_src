...
CREATE TABLE `stationery` (
  ...
  `currency` varchar(100) NOT NULL DEFAULT 'null',
  PRIMARY KEY (`id`)
...
INSERT INTO `stationery` VALUES (1,'pencil',5,'rupees'),(2,'pen',10,'rupees'),(3,'book',2,'dollars'),(4,'diary',1,'omani riyal');
...
-- Dump completed on 2022-05-20 14:43:44
